...
<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href=""> Add Testimonial </a></li>
        </ol>
    </div>
    <!-- row -->
    <div class="row">
                    ...
                    <form method="POST" action="{{ route('create_testimonial') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4 col-lg-6 col-md-6">
                                ...
                                <input type="text" value="{{ old('client_name') }}" name="client_name" class="form-control" placeholder="Client Name">
                            ...
                            <div class="mb-4 col-lg-6 col-md-6">
                                ...
                                <select class="form-select" name="review" aria-label="Default select example">
                                    ...
                                    <option value="5" {{ old('review') == '5' ? 'selected' : '' }}>5</option>
                                    <option value="4" {{ old('review') == '4' ? 'selected' : '' }}>4</option>
                                    <option value="3" {{ old('review') == '3' ? 'selected' : '' }}>3</option>
                                    <option value="2" {{ old('review') == '2' ? 'selected' : '' }}>2</option>
                                    <option value="1" {{ old('review') == '1' ? 'selected' : '' }}>1</option>
                                </select>
                            ...
                            <div class="col-md-4 mb-4">
                                <label class="form-label">Client Profile (Image should not be more than 5mb)</label>
