                    ...
                    <div class="property-card style-1">
                        ...
                        <div class="dz-content">
                            ...
                            <div class="dz-footer">
                                ...
                                <ul class="action">
                                    <li>
                                        <a href="{{ route('delete_property', $property->id) }}" onclick="return confirm('Are you sure you want to delete this property?')" class="btn btn-danger px-2">Delete</a>
                                    </li>

                                    <li>
                                        <a href="{{ route('edit_property', $property->id) }}" onclick="return confirm('Are you sure you want to edit this property?')" class="btn btn-warning px-2">Edit</a>
                                    </li>
