        ...
        <div class="container-fluid">
            <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
                <div class="me-auto d-lg-block d-block">
                    ...
                    <p class="mb-0">Welcome to Ifeneti Global Service Agent Dashboard</p>
                </div>
                <a href="{{ route('agent_dashboard') }}" class="btn btn-primary rounded light">Refresh</a>
            </div>
            <div class="row">
                            ...
                            <div class="card bg-danger property-bx text-white">
                                <div class="card-body">
                                    <div class="media d-sm-flex d-block align-items-center">
                                        ...
                                        <span class="fs-35 font-w500">{{ $agentPropertyCount }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
