    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="forHouse" action="{{ route('agent_store_property') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="mb-4 col-md-12">
                                ...
                                <textarea id="summernote" class="form-control" name="description" placeholder="Property Description" rows="4">{{ old('description') }}</textarea>
